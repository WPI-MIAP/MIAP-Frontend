/**
 * Draws the profile view of a drug or DDI
 * @param data The dataset to use
 * @param div_id The id of the div the profile view is contained in
 * @param check Whether the data represents a drug or a DDI
 */
function draw_zoom_tree(data, div_id, check){
    ...
    /** A recursive helper function for performing some setup by walking through all the nodes
     * @param parent The parent node
     * @param visitFn the function to perform on each node
     * @param childrenFn the function to get the children of the parent
     * @memberof draw_zoom_tree
     * @method visit
     */
    ...
    /** 
     * Helper function to sort the tree according to the node names
     * @memberof draw_zoom_tree
     * @method sortTree
     */
    // TODO: make this more generic, i.e. take a tree as a parameter and sort that
    function sortTree() {
     ...
     * @param domNode The object from which the script is running
     * @param direction The direction in wich the visualization is panning
     * @memberof draw_zoom_tree
     * @method pan
     */
    ...
    /**
     * Function to resize the visualization window based on the div
     * @memberof draw_zoom_tree
     * @method resize
     */
    function resize() {
    ...
    /** 
     * Zoom function for the zoomable tree
     * @memberof draw_zoom_tree
     * @method zoom
     */
    function zoom() {
    ...
    // TODO: Right now this function is never called. Remove?
   ...
   dragListener = d3.behavior.drag()
    ...
    /** 
     * End behavior for dragging in the visualization
     * @memberof draw_zoom_tree
     * @method endDrag
     */
    function endDrag() {
    ...
    /**
     * Helper function for collapsing nodes 
    ...
    /**
     * Helper function for expanding nodes
     * @param d Node to expand
     * @memberof draw_zoom_tree
     * @method expand
     */
    function expand(d) {
    ...
    /** 
     * Function to center node when clicked/dropped so node doesn't get lost when collapsing/moving with large amounts of children
     * @param source Node to center around
     * @memberof draw_zoom_tree
     * @method centerNode
     */
    ...
    /**
     * Function to toggle children of an node, expanding or collapsing them
     * @param d Node to toggle
     * @memberof draw_zoom_tre
    ...
    /**
     * Function to handle clicks on a node, to toggle children
     * @param d Node that was clicked on 
     * @memberof draw_zoom_tree
     * @method click
     */
    function click(d) {
    ...
    /**
     * Compute the new height of a tree
     * @param source Source node of the tree
     * @memberof draw_zoom_tree
     * @method update
     */
    function update(source) {
        /** Count total children of root node and sets tree height accordingly.
